...
public class LibraryView implements IConsoleView {
  ...
  public int showMenuAndGetChoice() {
    ...
    System.out.println("1. Add a new Model.domain.Movie/Model.domain.TVShow");
    System.out.println("2. View entire library");
    System.out.println("3. Search for Model.domain.Movie/Model.domain.TVShow");
    System.out.println("4. Delete Model.domain.Movie/Model.domain.TVShow");
  ...
  public IMediaItem askForNewMediaItem() {
    ...
    if (mediaType.equalsIgnoreCase("Model.domain.Movie")) {
      IMediaItem newItem = new Movie(title, year, genre, rating, MediaType.MOVIE);
      return newItem;
    } else if (mediaType.equalsIgnoreCase("Model.domain.TVShow")) {
